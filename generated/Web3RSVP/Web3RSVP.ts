...
export class ReturnClaimCall extends ethereum.Call {
  get inputs(): ReturnClaimCall__Inputs {
    return new ReturnClaimCall__Inputs(this);
  }

  get outputs(): ReturnClaimCall__Outputs {
    return new ReturnClaimCall__Outputs(this);
  }
}

export class ReturnClaimCall__Inputs {
  _call: ReturnClaimCall;

  constructor(call: ReturnClaimCall) {
    this._call = call;
  }
...
export class ReturnClaimCall__Outputs {
  _call: ReturnClaimCall;
